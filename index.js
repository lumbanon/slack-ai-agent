...
class SlackAIAgent {
  ...
  async analyzeWithAI(memberInfo, researchData) {
    try {
      ...
      const prompt = `Analyze this new community member for fit with our commercial product.
...
Return only valid JSON with this exact shape:
{
  ...
  "recommendations": ["2-4 engagement suggestions"]
}

The fitScore must be an integer from 0 to 100. Consider job title, company size, technical background, and budget authority.`;
